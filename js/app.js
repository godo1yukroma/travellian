(() => {
    ...
    function initSliders() {
        if (document.querySelector(".destinations__slider")) new core(".destinations__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 3.4,
        ...
        if (document.querySelector(".offer__slider")) new core(".offer__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
        ...
        if (document.querySelector(".planners__slider")) new core(".planners__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 3.4,
        ...
        if (document.querySelector(".experiences__slider")) new core(".experiences__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
